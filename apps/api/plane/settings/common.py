...
FILE_SIZE_LIMIT = int(os.environ.get("FILE_SIZE_LIMIT", 524288000))  # 500MB default
...
DATA_UPLOAD_MAX_MEMORY_SIZE = int(os.environ.get("FILE_SIZE_LIMIT", 524288000))  # 500MB default
